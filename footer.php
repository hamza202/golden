                ...
                <div class="single-footer-widget">
                    <div class="quick-links">
                        ...
                        <ul class="left-quick-links alignleft">
                            ...
                            <li><i class="fa fa-angle-right"></i><a href="#">Activities</a></li>
                        </ul>
                        <ul>
                            <li><i class="fa fa-angle-right"></i><a href="#">Projects</a></li>
                            <li><i class="fa fa-angle-right"></i><a href="#">Vision 2030</a></li>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="copy-right-text">
                    <p>Copyright © Golden Advanced 2018 . All rights reserved. </p>
                </div>
            </div>
        </div>
    </div>
